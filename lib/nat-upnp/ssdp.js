...
Ssdp.prototype.createSocket = function createSocket(conn) {
  var self = this;
  var socket = dgram.createSocket(conn.family === 'IPv4' ?
                                  'udp4' : 'udp6');
  ...
  process.nextTick(function() {
    ...
    socket.address = conn.address;
    socket.bind(self._sourcePort, conn.address);
  });
